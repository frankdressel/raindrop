...
_CUSTOMCONFIGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='username', full_name='CustomConfigRequest.username', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='password', full_name='CustomConfigRequest.password', index=1,
...
CustomConfigRequest = _reflection.GeneratedProtocolMessageType('CustomConfigRequest', (_message.Message,), {
...
CustomConfigResponse = _reflection.GeneratedProtocolMessageType('CustomConfigResponse', (_message.Message,), {
