...
/* Generated from: proto/custom_config.proto */
...
{
  static CustomConfigRequest init_value = CUSTOM_CONFIG_REQUEST__INIT;
  *message = init_value;
}
...
{
  static CustomConfigResponse init_value = CUSTOM_CONFIG_RESPONSE__INIT;
  *message = init_value;
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, username),
    NULL,
    NULL,
    0,             /* flags */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, password),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    offsetof(CustomConfigResponse, has_status),
  ...
  },
  {
    ...
    offsetof(CustomConfigResponse, has_dummy),
